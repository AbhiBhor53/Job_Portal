...
th, td {
  padding: 25px;
           ...
           <div class="container" style="width:1400px;" align="center"> 
                 <br></br> 
                <h3 align="center"><font color="blue">COMPANIES</h3>  
...
<div align="center" >
    ...
    <font color ="blue"><font size="4px">Enter The Company Name From Following List To View Details :
...
<table  style="background-color:#FFFFE0;" >
  <tr>
    <th><font color="blue">Comapny Campus</th>
    <th><font color="blue">Comapny Name</th>
    <th><font color="blue">Comapny Location</th>
    <th><font color="blue">Primary Skill Required </th>
    
  </tr>
                
<?php
               
                $query = "SELECT * FROM comtbl_image ORDER BY id DESC";  
...
?> 
                      ...
                      <tr>
                               ...
                               <td><font color="red">  <?php echo $row['comname'];?></td>
                               <td><font color="red"> <?php echo $row['location'];?></td>
                               <td><font color="red"> <?php echo $row['firstskill'];?></td>
